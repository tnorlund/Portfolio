...
_CACHED_ARITHMETIC_OUTPUT_SIZE = (320, 1176)
_CACHED_ADDRESS_OUTPUT_SIZE = (416, 1280)
_CACHED_THERMAL_DARK_SPECKLE_RATE = 0.044
_CACHED_THERMAL_LIGHT_SPECKLE_RATE = 0.066
_CACHED_THERMAL_MIN_DARK_DENSITY = 0.105
_CACHED_REMOVE_THERMAL_MIN_DARK_DENSITY = 0.137
_CACHED_ADDRESS_THERMAL_MIN_DARK_DENSITY = 0.110
...
def _cached_thermal_min_dark_density(receipt: dict) -> float:
    ...
    if "address-line" in candidate_id:
        return _CACHED_ADDRESS_THERMAL_MIN_DARK_DENSITY
