...
Usage:
    ...
    python3.14 scripts/backfill_receipt_line_items.py --check \
        --table ReceiptsTable-d7ff76a

    # dry run / write, dev only
    python3.14 scripts/backfill_receipt_line_items.py
    python3.14 scripts/backfill_receipt_line_items.py --apply
    python3.14 scripts/backfill_receipt_line_items.py \
