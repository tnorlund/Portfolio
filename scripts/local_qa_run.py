...
Usage:
    python3.14 scripts/local_qa_run.py --questions 24,13,10   # subset
    python3.14 scripts/local_qa_run.py --all                  # all 32
    python3.14 scripts/local_qa_run.py --all --dry-run        # no upload
    python3.14 scripts/local_qa_run.py --questions 24 --model openai/gpt-5.6-luna
