...
Usage:
    python3.14 scripts/extend_items_zone_gaps.py                # dry run
    python3.14 scripts/extend_items_zone_gaps.py --apply
    python3.14 scripts/extend_items_zone_gaps.py --histogram
    python3.14 scripts/extend_items_zone_gaps.py --receipt IMG_ID:1
"""
