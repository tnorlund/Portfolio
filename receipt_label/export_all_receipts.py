...
def export_all_receipts():
    ...
    while True:
        images_result = dynamo_client.list_images(limit=100, last_evaluated_key=last_evaluated_key)
    ...
    print(f"   ✅ Total successfully exported: {total_exported}/{len(all_images)}")
