...
def print_summary():
    ...
    print("- Used existing export/import functionality from receipt_dynamo package")
    print("- Downloaded real receipt data from production table 'ReceiptsTable-d7ff76a'")
    ...
    print("- Merchants tested: Italia Deli & Bakery, Vons, Sprouts Farmers Market")
    ...
    print("4. Validated that pattern detection enhancements work with real data")
    print("5. Demonstrated excellent performance with advanced optimization level")
    print()
    
    print("📈 NEXT STEPS FOR COST ANALYSIS:")
    print("- Configure pattern detection for specific merchants tested")
    print("- Compare performance between Legacy vs Advanced optimization levels")
    ...
    print("Status: Pattern detection system validated and ready for cost analysis")
...
if __name__ == "__main__":
    ...
    print("1. Export data:")
    print("   python scripts/export_data_using_existing_tools.py sample --size 5")
    print()
    print("2. Test pattern detection:")
    print("   python scripts/test_pattern_detection_with_exported_data.py ./receipt_data_existing --optimization-level advanced --limit 3")
    print()
    print("3. Compare optimization levels:")
    print("   python scripts/test_pattern_detection_with_exported_data.py ./receipt_data_existing --compare-all --limit 2")
    print()