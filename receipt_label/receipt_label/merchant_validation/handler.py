...
def create_validation_handler(api_key: Optional[str] = None) -> MerchantValidationHandler:
    """
    ...
    if not api_key:
        raise ValueError("Google Places API key must be provided or set in GOOGLE_PLACES_API_KEY env var")
