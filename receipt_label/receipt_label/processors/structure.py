...
class StructureProcessor:
    ...
    def __init__(self):
        ...
        self.section_patterns = {
            ...
            "items": {
                "keywords": ["item", "description", "qty", "quantity", "price", "amount"],
                "position": "middle",
                "min_lines": 3,
            },
            "totals": {
    ...
    def analyze_structure(
        ...
        overall_confidence = sum(section.confidence for section in sections) / len(sections) if sections else 0.0
