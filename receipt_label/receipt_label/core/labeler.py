...
class ReceiptLabeler:
    ...
    def __init__(
        ...
        """
        self.places_processor = BatchPlacesProcessor(places_api_key, dynamodb_table_name)
    ...
    async def _get_places_data(self, receipt: Receipt) -> Optional[Dict]:
        ...
        try:
            ...
            enriched_receipt = self.places_processor.process_receipt_batch([receipt_dict])[0]
    ...
    async def _analyze_structure(
        ...
        return self.structure_processor.analyze_structure(
