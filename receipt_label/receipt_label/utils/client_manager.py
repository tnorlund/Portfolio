...
class ClientManager:
    ...
    This class provides a centralized way to access all external service clients
    ...
    def __init__(self, config: ClientConfig):
        ...
        self._pinecone_index: Optional[Pinecone.Index] = None
    ...
    @property
    def pinecone(self) -> Pinecone.Index:
    ...
    def get_all_clients(self) -> tuple[DynamoClient, OpenAI, Pinecone.Index]:
        """
