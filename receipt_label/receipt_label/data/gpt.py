...
def gpt_request_structure_analysis(
    ...
    """
    from receipt_dynamo.data._gpt import gpt_request_structure_analysis as _gpt_request_structure_analysis
    return _gpt_request_structure_analysis(receipt, receipt_lines, receipt_words, places_api_data, gpt_api_key)
...
def gpt_request_field_labeling(
    ...
    Forward to the actual implementation in receipt_dynamo.
    """
    from receipt_dynamo.data._gpt import gpt_request_field_labeling as _gpt_request_field_labeling
    return _gpt_request_field_labeling(receipt, receipt_lines, receipt_words, section_boundaries, places_api_data, gpt_api_key)