...
def test_cluster_partial_similarity() -> None:
    ...
    assert walmart_cluster != target_cluster, "Walmart and Target should be in different clusters"
...
def test_cluster_with_missing_fields() -> None:
    ...
    assert 2 in starbucks_cluster, "Starbucks records should cluster based on name and address"
...
def test_cluster_address_variations() -> None:
    ...
    records = [
        ...
        _build_metadata(
            4,
            name="Target",
            address="123 MAIN STREET"  # Case variation
        ),
    ]
...
def test_cluster_large_dataset_performance() -> None:
    ...
    starbucks_phones = ["415-555-0001", "(415) 555-0001", "4155550001", "415.555.0001", "415-555-0001"]
    starbucks_addresses = ["100 Market St", "100 Market Street", "100 Market St.", "100 MARKET ST", "100 Market St"]
    for i in range(5):
        records.append(_build_metadata(
            i + 1,
