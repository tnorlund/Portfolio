...
class TestDateUtils:
    def test_parse_datetime(self):
        ...
        assert parse_datetime("2024-03-15", "invalid") is not None  # Should return date only
    ...
    def test_format_datetime(self):
        ...
        assert format_datetime(dt, include_time=True, include_seconds=False) == "2024-03-15 14:30"
        
        # Test date and time with seconds
        assert format_datetime(dt, include_time=True, include_seconds=True) == "2024-03-15 14:30:45"
