...
def main():
    ...
    if "ParamValidationError" in categories:
        ...
        print(
            "   - These tests expect boto3's ParamValidationError for negative limits"
        )
        print(
            "   - Our code correctly validates early with EntityValidationError"
        )
