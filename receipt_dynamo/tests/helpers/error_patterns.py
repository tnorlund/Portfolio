...
class ErrorPatterns:
    ...
    VALIDATION_MUST_BE_INSTANCE = re.compile(
        r"\w+ must be an instance of the \w+ class"
    )
...
class FlexibleErrorMatcher:
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        if self.patterns and not ErrorPatterns.matches_any(
            error_message, *self.patterns
        ):
            raise AssertionError(
