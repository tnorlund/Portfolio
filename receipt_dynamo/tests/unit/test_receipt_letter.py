...
def test_receipt_letter_init_valid(example_receipt_letter):
    ...
    assert example_receipt_letter.bounding_box == {"x": 0.1,
        "y": 0.2,
        "width": 0.05,
        "height": 0.05,}
...
def test_to_item(example_receipt_letter):
    ...
    assert example_receipt_letter.to_item() == {"PK": {"S": "IMAGE#3f52804b-2fad-4e00-92c8-b593da3a8ed3"},
        "SK": {"S": "RECEIPT#00001#LINE#00003#WORD#00004#LETTER#00005"},
        "TYPE": {"S": "RECEIPT_LETTER"},
        "text": {"S": "A"},
        "bounding_box": {"M": {"height": {"N": "0.05000000000000000000"},
                "width": {"N": "0.05000000000000000000"},
                "x": {"N": "0.10000000000000000000"},
                "y": {"N": "0.20000000000000000000"},}},
        "top_right": {"M": {"x": {"N": "0.15000000000000000000"},
                "y": {"N": "0.25000000000000000000"},}},
        "top_left": {"M": {"x": {"N": "0.10000000000000000000"},
                "y": {"N": "0.25000000000000000000"},}},
        "bottom_right": {"M": {"x": {"N": "0.15000000000000000000"},
                "y": {"N": "0.20000000000000000000"},}},
        "bottom_left": {"M": {"x": {"N": "0.10000000000000000000"},
                "y": {"N": "0.20000000000000000000"},}},
...
def test_iter(example_receipt_letter):
    ...
    assert receipt_letter_dict["bounding_box"] == {"x": 0.1,
        "y": 0.2,
        "width": 0.05,
        "height": 0.05,}
...
def test_repr(example_receipt_letter):
    ...
    assert repr(example_receipt_letter) == ("ReceiptLetter("
        "receipt_id=1, "
...
def test_item_to_word(example_receipt_letter):
    ...
    with pytest.raises(ValueError, match="^Error converting item to ReceiptLetter: "):
        itemToReceiptLetter({"PK": {"S": "IMAGE#3f52804b-2fad-4e00-92c8-b593da3a8ed3"},
                "SK": {"S": "RECEIPT#00001#LINE#00003#WORD#00004#LETTER#00005"},
                "TYPE": {"S": "RECEIPT_LETTER"},
                "text": {"N": "1"},
                "bounding_box": {"M": {"x": {"N": "0.0500000000"},
                        "y": {"N": "0.1000000000"},
                        "width": {"N": "0.0500000000"},
                        "height": {"N": "0.0500000000"},}},
                "top_right": {"M": {"x": {"N": "0.1500000000"},
                        "y": {"N": "0.2500000000"},}},
                "top_left": {"M": {"x": {"N": "0.1000000000"},
                        "y": {"N": "0.2500000000"},}},
                "bottom_right": {"M": {"x": {"N": "0.1500000000"},
                        "y": {"N": "0.2000000000"},}},
                "bottom_left": {"M": {"x": {"N": "0.1000000000"},
                        "y": {"N": "0.2000000000"},}},
                "angle_degrees": {"N": "0.0"},
                "angle_radians": {"N": "0.0"},
                "confidence": {"N": "0.99"},})
