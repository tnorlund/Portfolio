...
def test_receipt_line_eq():
    line1 = ReceiptLine(receipt_id=1,
        image_id="3f52804b-2fad-4e00-92c8-b593da3a8ed3",
        line_id=3,
        text="Line text",
...
def test_receipt_line_repr(example_receipt_line):
    assert repr(example_receipt_line) == ("ReceiptLine("
        "receipt_id=1, "
        "image_id='3f52804b-2fad-4e00-92c8-b593da3a8ed3', "
        "line_id=10, "
        "text='Line text', "
...
def test_item_to_receipt_line(example_receipt_line):
    assert (itemToReceiptLine(example_receipt_line.to_item())
    ...
    with pytest.raises(ValueError, match="^Error converting item to ReceiptLine"):
        itemToReceiptLine({"PK": {"S": "IMAGE#3f52804b-2fad-4e00-92c8-b593da3a8ed3"},
