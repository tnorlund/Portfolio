...
def test_item_to_word_tag():
    ...
    """
    item = {"PK": {"S": "IMAGE#3f52804b-2fad-4e00-92c8-b593da3a8ed3"},
        "SK": {"S": "LINE#00007#WORD#00101#TAG#_________________________________example"},
        "GSI1PK": {"S": "TAG#_________________________________example"},
        "GSI1SK": {"S": "IMAGE#3f52804b-2fad-4e00-92c8-b593da3a8ed3#LINE#00007#WORD#00101"},
        "TYPE": {"S": "WORD_TAG"},
        "tag_name": {"S": "example"},
...
def test_item_to_word_tag_invalid_format():
    ...
    bad_format_item = {"PK": {"S": "IMAGE#42"},  # Not zero-padded, missing pieces
