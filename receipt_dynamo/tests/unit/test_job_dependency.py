...
def test_job_dependency_init_valid(example_job_dependency, example_job_dependency_minimal):
    ...
    assert (example_job_dependency.dependent_job_id
        == "3f52804b-2fad-4e00-92c8-b593da3a8ed3")
    assert (example_job_dependency.dependency_job_id
    ...
    assert (example_job_dependency_minimal.dependent_job_id
        == "3f52804b-2fad-4e00-92c8-b593da3a8ed3")
    assert (example_job_dependency_minimal.dependency_job_id
        == "4f52804b-2fad-4e00-92c8-b593da3a8ed4")
...
def test_job_dependency_init_self_dependency():
    """Test the JobDependency constructor with same IDs for dependent and dependency."""
...
def test_job_dependency_iter(example_job_dependency):
    ...
    assert (job_dependency_dict["dependent_job_id"]
        == "3f52804b-2fad-4e00-92c8-b593da3a8ed3")
    assert (job_dependency_dict["dependency_job_id"]
        == "4f52804b-2fad-4e00-92c8-b593da3a8ed4")
...
def test_job_dependency_eq():
    ...
    job_dep1 = JobDependency("3f52804b-2fad-4e00-92c8-b593da3a8ed3",
        "4f52804b-2fad-4e00-92c8-b593da3a8ed4",
        "SUCCESS",
        "2021-01-01T12:30:45",
        "condition",)
    ...
    job_dep3 = JobDependency("5f52804b-2fad-4e00-92c8-b593da3a8ed5",
        "4f52804b-2fad-4e00-92c8-b593da3a8ed4",
        "SUCCESS",
        "2021-01-01T12:30:45",
        "condition",)
    ...
    job_dep4 = JobDependency("3f52804b-2fad-4e00-92c8-b593da3a8ed3",
    ...
    # Different type
    job_dep5 = JobDependency("3f52804b-2fad-4e00-92c8-b593da3a8ed3",
        "4f52804b-2fad-4e00-92c8-b593da3a8ed4",
        "ARTIFACT",
        "2021-01-01T12:30:45",
        "condition",)
    ...
    job_dep6 = JobDependency("3f52804b-2fad-4e00-92c8-b593da3a8ed3",
        "4f52804b-2fad-4e00-92c8-b593da3a8ed4",
        "SUCCESS",
        "2021-01-02T12:30:45",
        "condition",)
    ...
    # Different condition
    job_dep7 = JobDependency("3f52804b-2fad-4e00-92c8-b593da3a8ed3",
        "4f52804b-2fad-4e00-92c8-b593da3a8ed4",
        "SUCCESS",
        "2021-01-01T12:30:45",
        "different condition",)
...
def test_itemToJobDependency(example_job_dependency, example_job_dependency_minimal):
    ...
    # Test with full job dependency
    item = example_job_dependency.to_item()
    job_dependency = itemToJobDependency(item)
    ...
    with pytest.raises(ValueError, match="Invalid item format"):
        itemToJobDependency({"PK": {"S": "JOB#id"}, "SK": {"S": "DEPENDS_ON#dependency_id"}})

    # Test with invalid item format
    with pytest.raises(ValueError, match="Error converting item to JobDependency"):
        itemToJobDependency({"PK": {"S": "JOB#3f52804b-2fad-4e00-92c8-b593da3a8ed3"},
                "SK": {"S": "DEPENDS_ON#4f52804b-2fad-4e00-92c8-b593da3a8ed4"},
