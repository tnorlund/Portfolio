...
def test_job_log_to_item(example_job_log, example_job_log_minimal):
    ...
    assert item["GSI1SK"] == {"S": "JOB#3f52804b-2fad-4e00-92c8-b593da3a8ed3#2021-01-01T12:30:45"}
...
def test_job_log_eq():
    ...
    # Same job logs
    job_log1 = JobLog("3f52804b-2fad-4e00-92c8-b593da3a8ed3", "2021-01-01T12:30:45", "INFO", "Test message", "source", "exception")
    job_log2 = JobLog("3f52804b-2fad-4e00-92c8-b593da3a8ed3", "2021-01-01T12:30:45", "INFO", "Test message", "source", "exception")
    assert job_log1 == job_log2, "Should be equal"

    # Different job_id
    job_log3 = JobLog("4f52804b-2fad-4e00-92c8-b593da3a8ed3", "2021-01-01T12:30:45", "INFO", "Test message", "source", "exception")  
    assert job_log1 != job_log3, "Different job_id"

    # Different timestamp
    job_log4 = JobLog("3f52804b-2fad-4e00-92c8-b593da3a8ed3", "2021-01-01T12:31:45", "INFO", "Test message", "source", "exception")  
    assert job_log1 != job_log4, "Different timestamp"

    # Different log_level
    job_log5 = JobLog("3f52804b-2fad-4e00-92c8-b593da3a8ed3", "2021-01-01T12:30:45", "ERROR", "Test message", "source", "exception")  
    assert job_log1 != job_log5, "Different log_level"

    # Different message
    job_log6 = JobLog("3f52804b-2fad-4e00-92c8-b593da3a8ed3", "2021-01-01T12:30:45", "INFO", "Different message", "source", "exception")  
    assert job_log1 != job_log6, "Different message"

    # Different source
    job_log7 = JobLog("3f52804b-2fad-4e00-92c8-b593da3a8ed3", "2021-01-01T12:30:45", "INFO", "Test message", "different_source", "exception")  
    assert job_log1 != job_log7, "Different source"

    # Different exception
    job_log8 = JobLog("3f52804b-2fad-4e00-92c8-b593da3a8ed3", "2021-01-01T12:30:45", "INFO", "Test message", "source", "different_exception")  
