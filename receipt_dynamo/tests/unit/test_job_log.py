...
def test_job_log_init_valid(example_job_log, example_job_log_minimal):
    ...
    assert (example_job_log_minimal.job_id
...
def test_job_log_eq():
    ...
    # Same job logs
    job_log1 = JobLog("3f52804b-2fad-4e00-92c8-b593da3a8ed3",
        "2021-01-01T12:30:45",
        "INFO",
        "Test message",
        "source",
    ...
    # Different job_id
    job_log3 = JobLog("4f52804b-2fad-4e00-92c8-b593da3a8ed3",
        "2021-01-01T12:30:45",
        "INFO",
        "Test message",
        "source",
    ...
    # Different timestamp
    job_log4 = JobLog("3f52804b-2fad-4e00-92c8-b593da3a8ed3",
        "2021-01-01T12:31:45",
        "INFO",
        "Test message",
        "source",
    ...
    # Different log_level
    job_log5 = JobLog("3f52804b-2fad-4e00-92c8-b593da3a8ed3",
        "2021-01-01T12:30:45",
        "ERROR",
        "Test message",
        "source",
    ...
    # Different message
    job_log6 = JobLog("3f52804b-2fad-4e00-92c8-b593da3a8ed3",
        "2021-01-01T12:30:45",
        "INFO",
        "Different message",
        "source",
    ...
    # Different source
    job_log7 = JobLog("3f52804b-2fad-4e00-92c8-b593da3a8ed3",
        "2021-01-01T12:30:45",
        "INFO",
        "Test message",
        "different_source",
    ...
    # Different exception
    job_log8 = JobLog("3f52804b-2fad-4e00-92c8-b593da3a8ed3",
        "2021-01-01T12:30:45",
        "INFO",
        "Test message",
        "source",
...
def test_itemToJobLog(example_job_log, example_job_log_minimal):
    ...
    with pytest.raises(ValueError, match="Error converting item to JobLog"):
        itemToJobLog({"PK": {"S": "JOB#3f52804b-2fad-4e00-92c8-b593da3a8ed3"},
                "SK": {"S": "LOG#2021-01-01T12:30:45"},
                "TYPE": {"S": "JOB_LOG"},
