...
from receipt_dynamo.entities.job_resources import _parse_dynamodb_map
...
def test_job_resource_init_valid(example_job_resource):
    ...
    assert example_job_resource.resource_config == {"memory_mb": 61440, "vcpus": 8}
...
def test_job_resource_iter(example_job_resource):
    ...
    assert job_resource_dict["resource_config"] == {"memory_mb": 61440, "vcpus": 8}
