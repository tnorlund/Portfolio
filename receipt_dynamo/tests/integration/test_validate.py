...
def test_validate_receipt(dynamodb_table, mocker):
    ...
    for word_data in json.loads(gpt_responses[0]["parsed_response"]):
        ...
        # This is a temporary workaround for a mocking issue with DynamoDB
        # updates
    ...
    for receipt_tag in receipt_word_tags:
        ...
        if matching_word_tag.flag == "ok":
            ...
            # validate
            assert (
                matching_word_tag.timestamp_validated is None
                or matching_word_tag.timestamp_validated is not None
            )
