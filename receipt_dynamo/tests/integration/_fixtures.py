...
def sample_gpt_receipt_1():
    ...
    """
    json_path = os.path.join(CURRENT_DIR, "JSON", "5119873a-5401-4dd1-9669-878dff8b5bd5.json")
    with open(json_path, "r") as f:
        data = json.load(f)
    return ([Image(**image_dict) for image_dict in data["images"]],
        ...
        {"store_name": {"value": "VONS",
            ...
            "phone_number": {"value": "877-276-9637",
                "word_centroids": [{"x": 0.261267280794621, "y": 0.01903172766152822}],},
            "total_amount": {"value": 3.6,
                "word_centroids": [{"x": 0.7717564238292309, "y": 0.2714470647540924}],},
            "items": [{"item_name": {"value": "PURE LIFE WATER",
                        "word_centroids": [{"x": 0.26749815892255185,
                    ...
                    "price": {"value": 3.6,
                        "word_centroids": [{"x": 0.6804826678128096, "y": 0.40209401707470505}],},}],
            "taxes": {"value": 0.0, "word_centroids": []},
            "address": {"value": "2725 Agoura Road WESTLAKE CA 91360",
                "word_centroids": [{"x": 0.6391207477919513, "y": 0.8665352414902137},
