...
def test_add_queue_success(queue_dynamo, sample_queue):
...
@pytest.mark.integration
def test_add_queue_raises_value_error(queue_dynamo):
...
@pytest.mark.integration
def test_add_queue_raises_value_error_queue_not_instance(queue_dynamo):
...
@pytest.mark.integration
def test_add_queue_raises_conditional_check_failed(queue_dynamo, sample_queue):
    """
...
@pytest.mark.integration
def test_add_queue_raises_resource_not_found(
...
@pytest.mark.integration
def test_add_queues_success(queue_dynamo):
...
@pytest.mark.integration
def test_add_queues_empty_list(queue_dynamo):
...
@pytest.mark.integration
def test_add_queues_handles_unprocessed_items(queue_dynamo, monkeypatch):
...
@pytest.mark.integration
def test_update_queue_success(queue_dynamo, sample_queue):
...
@pytest.mark.integration
def test_update_queue_raises_value_error_none(queue_dynamo):
...
@pytest.mark.integration
def test_update_queue_raises_value_error_not_instance(queue_dynamo):
...
@pytest.mark.integration
def test_update_queue_raises_queue_not_found(queue_dynamo, sample_queue):
...
@pytest.mark.integration
def test_delete_queue_success(queue_dynamo, sample_queue):
...
@pytest.mark.integration
def test_delete_queue_raises_value_error_none(queue_dynamo):
...
@pytest.mark.integration
def test_delete_queue_raises_value_error_not_instance(queue_dynamo):
...
@pytest.mark.integration
def test_delete_queue_raises_queue_not_found(queue_dynamo, sample_queue):
...
@pytest.mark.integration
def test_get_queue_success(queue_dynamo, sample_queue):
...
@pytest.mark.integration
def test_get_queue_raises_value_error_none(queue_dynamo):
    """
...
@pytest.mark.integration
def test_get_queue_raises_value_error_empty(queue_dynamo):
    """
...
@pytest.mark.integration
def test_get_queue_queue_not_found(queue_dynamo):
...
@pytest.mark.integration
def test_list_queues_success(queue_dynamo):
...
@pytest.mark.integration
def test_list_queues_with_limit(queue_dynamo):
...
@pytest.mark.integration
def test_list_queues_with_pagination(queue_dynamo):
...
@pytest.mark.integration
def test_list_queues_with_invalid_last_evaluated_key(queue_dynamo):
    """
...
@pytest.mark.integration
def test_add_job_to_queue_success(
...
@pytest.mark.integration
def test_add_job_to_queue_raises_value_error_none(queue_dynamo):
...
@pytest.mark.integration
def test_add_job_to_queue_raises_value_error_not_instance(queue_dynamo):
...
@pytest.mark.integration
def test_add_job_to_queue_queue_not_found(queue_dynamo, sample_queue_job):
    """
...
@pytest.mark.integration
def test_remove_job_from_queue_success(
...
@pytest.mark.integration
def test_remove_job_from_queue_raises_value_error_none(queue_dynamo):
...
@pytest.mark.integration
def test_remove_job_from_queue_raises_value_error_not_instance(queue_dynamo):
    """
...
@pytest.mark.integration
def test_remove_job_from_queue_queue_not_found(queue_dynamo, sample_queue_job):
    """
...
@pytest.mark.integration
def test_remove_job_from_queue_job_not_in_queue(
    queue_dynamo, sample_queue, sample_queue_job
):
    """
...
@pytest.mark.integration
def test_list_jobs_in_queue_success(queue_dynamo, sample_queue, sample_job):
...
@pytest.mark.integration
def test_list_jobs_in_queue_with_limit(queue_dynamo, sample_queue, sample_job):
...
@pytest.mark.integration
def test_list_jobs_in_queue_raises_value_error_none_queue_name(queue_dynamo):
    """
...
@pytest.mark.integration
def test_list_jobs_in_queue_raises_value_error_empty_queue_name(queue_dynamo):
    """
...
@pytest.mark.integration
def test_list_jobs_in_queue_queue_not_found(queue_dynamo, monkeypatch):
    """
...
@pytest.mark.integration
def test_find_queues_for_job_success(queue_dynamo, sample_job):
...
@pytest.mark.integration
def test_find_queues_for_job_with_limit(queue_dynamo, sample_job):
...
@pytest.mark.integration
def test_find_queues_for_job_raises_value_error_none_job_id(queue_dynamo):
...
@pytest.mark.integration
def test_find_queues_for_job_raises_value_error_empty_job_id(queue_dynamo):
    """
...
@pytest.mark.integration
def test_find_queues_for_job_with_no_queues(queue_dynamo, sample_job):
    """
