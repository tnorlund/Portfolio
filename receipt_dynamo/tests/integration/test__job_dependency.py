...
def test_add_job_dependency_success(
...
@pytest.mark.integration
def test_add_job_dependency_raises_value_error(job_dependency_dynamo):
    """
...
@pytest.mark.integration
def test_add_job_dependency_raises_value_error_job_not_instance(
    ...
    """
    with pytest.raises(
        ValueError, match="job_dependency must be a JobDependency instance"
    ):
        job_dependency_dynamo.add_job_dependency("not a job dependency")


@pytest.mark.integration
def test_add_job_dependency_raises_conditional_check_failed(
    job_dependency_dynamo, sample_job_dependency
):
    """
...
@pytest.mark.integration
def test_add_job_dependency_raises_resource_not_found(
...
@pytest.mark.integration
def test_get_job_dependency_success(
    job_dependency_dynamo, sample_job_dependency
):
...
@pytest.mark.integration
def test_get_job_dependency_raises_value_error_dependent_job_id_none(
    job_dependency_dynamo,
):
    """
...
@pytest.mark.integration
def test_get_job_dependency_raises_value_error_dependency_job_id_none(
    job_dependency_dynamo,
):
    """
...
@pytest.mark.integration
def test_get_job_dependency_raises_value_error_dependency_not_found(
    job_dependency_dynamo,
):
    """
    Test that getJobDependency raises ValueError when the job dependency is
    not found.
    """
...
@pytest.mark.integration
def test_list_dependencies_success(
...
@pytest.mark.integration
def test_list_dependencies_with_limit(
    job_dependency_dynamo, multiple_job_dependencies
):
...
@pytest.mark.integration
def test_list_dependencies_raises_value_error_dependent_job_id_none(
    job_dependency_dynamo,
):
    """
...
@pytest.mark.integration
def test_list_dependencies_empty_result(job_dependency_dynamo):
    """
...
@pytest.mark.integration
def test_list_dependents_success(job_dependency_dynamo):
...
@pytest.mark.integration
def test_list_dependents_with_limit(job_dependency_dynamo):
...
@pytest.mark.integration
def test_list_dependents_raises_value_error_dependency_job_id_none(
    job_dependency_dynamo,
):
    """
...
@pytest.mark.integration
def test_list_dependents_empty_result(job_dependency_dynamo):
    """
...
@pytest.mark.integration
def test_delete_job_dependency_success(
    job_dependency_dynamo, sample_job_dependency
):
...
@pytest.mark.integration
def test_delete_job_dependency_raises_value_error_dependency_none(
    job_dependency_dynamo,
):
    """
...
@pytest.mark.integration
def test_delete_job_dependency_raises_value_error_dependency_not_instance(
    job_dependency_dynamo,
):
    """
...
@pytest.mark.integration
def test_delete_job_dependency_raises_conditional_check_failed(
    job_dependency_dynamo, sample_job_dependency
):
    """
    Test that deleteJobDependency raises ValueError when the job dependency
    does not exist.
    """
...
@pytest.mark.integration
def test_delete_all_dependencies_success(
    job_dependency_dynamo, multiple_job_dependencies
):
...
@pytest.mark.integration
def test_delete_all_dependencies_raises_value_error_dependent_job_id_none(
    job_dependency_dynamo,
):
    """
...
@pytest.mark.integration
def test_delete_all_dependencies_no_dependencies(job_dependency_dynamo):
