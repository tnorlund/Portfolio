...
def test_add_job_success(job_dynamo, sample_job):
...
@pytest.mark.integration
def test_add_job_raises_value_error(job_dynamo):
...
@pytest.mark.integration
def test_add_job_raises_value_error_job_not_instance(job_dynamo):
...
@pytest.mark.integration
def test_add_job_raises_conditional_check_failed(job_dynamo, sample_job):
...
@pytest.mark.integration
def test_add_job_raises_resource_not_found(job_dynamo, sample_job, mocker):
    """
...
@pytest.mark.integration
def test_add_job_raises_provisioned_throughput_exceeded(
...
@pytest.mark.integration
def test_add_job_raises_internal_server_error(job_dynamo, sample_job, mocker):
    """
...
@pytest.mark.integration
def test_add_job_raises_unknown_error(job_dynamo, sample_job, mocker):
    """
...
@pytest.mark.integration
def test_add_jobs_success(job_dynamo, sample_job):
...
@pytest.mark.integration
def test_add_jobs_raises_value_error_jobs_none(job_dynamo):
...
@pytest.mark.integration
def test_add_jobs_raises_value_error_jobs_not_list(job_dynamo):
...
@pytest.mark.integration
def test_add_jobs_raises_value_error_jobs_not_list_of_jobs(
...
@pytest.mark.integration
def test_add_jobs_raises_clienterror_provisioned_throughput_exceeded(
    job_dynamo, sample_job, mocker
):
    """
...
@pytest.mark.integration
def test_add_jobs_raises_clienterror_internal_server_error(
    job_dynamo, sample_job, mocker
):
    """
...
@pytest.mark.integration
def test_add_jobs_raises_clienterror_validation_exception(
    job_dynamo, sample_job, mocker
):
    """
...
@pytest.mark.integration
def test_add_jobs_raises_clienterror_access_denied(
    job_dynamo, sample_job, mocker
):
    """
...
@pytest.mark.integration
def test_add_jobs_raises_clienterror(job_dynamo, sample_job, mocker):
    """
...
@pytest.mark.integration
def test_get_job_success(job_dynamo, sample_job):
...
@pytest.mark.integration
def test_add_jobs_unprocessed_items_retry(job_dynamo, sample_job, mocker):
    """
...
@pytest.mark.integration
def test_get_job_raises_value_error_job_id_none(job_dynamo):
...
@pytest.mark.integration
def test_get_job_raises_value_error_job_not_found(job_dynamo):
...
@pytest.mark.integration
def test_update_job_success(job_dynamo, sample_job):
...
@pytest.mark.integration
def test_update_job_raises_value_error_job_none(job_dynamo):
...
@pytest.mark.integration
def test_update_job_raises_value_error_job_not_instance(job_dynamo):
    """
...
@pytest.mark.integration
def test_update_job_raises_conditional_check_failed(job_dynamo, sample_job):
...
@pytest.mark.integration
def test_delete_job_success(job_dynamo, sample_job):
...
@pytest.mark.integration
def test_delete_job_raises_value_error_job_none(job_dynamo):
...
@pytest.mark.integration
def test_delete_job_raises_value_error_job_not_instance(job_dynamo):
    """
...
@pytest.mark.integration
def test_delete_job_raises_conditional_check_failed(job_dynamo, sample_job):
...
@pytest.mark.integration
def test_add_job_status_success(job_dynamo, sample_job, sample_job_status):
...
@pytest.mark.integration
def test_add_job_status_raises_value_error_status_none(job_dynamo):
...
@pytest.mark.integration
def test_add_job_status_raises_value_error_status_not_instance(job_dynamo):
    """
...
@pytest.mark.integration
def test_get_job_with_status_success(
    job_dynamo, sample_job, sample_job_status
):
...
@pytest.mark.integration
def test_get_latest_job_status_raises_value_error_no_status(
    job_dynamo, sample_job
):
    """
...
@pytest.mark.integration
def test_list_jobs_success(job_dynamo, sample_job):
...
@pytest.mark.integration
def test_list_jobs_with_limit(job_dynamo, sample_job):
...
@pytest.mark.integration
def test_list_job_statuses_success(job_dynamo, sample_job_status):
...
@pytest.mark.integration
def test_list_job_statuses_with_limit(job_dynamo, sample_job_status):
...
@pytest.mark.integration
def test_list_job_statuses_raises_value_error_job_id_none(job_dynamo):
...
@pytest.mark.integration
def test_list_jobs_raises_client_error_unknown(job_dynamo, mocker):
    """
...
@pytest.mark.integration
def test_list_jobs_raises_client_error_resource_not_found(job_dynamo, mocker):
    """
...
@pytest.mark.integration
def test_list_job_statuses_raises_client_error_resource_not_found(
    job_dynamo, mocker
):
    """
...
@pytest.mark.integration
def test_list_job_statuses_raises_client_error_internal_server_error(
    job_dynamo, mocker
):
    """
...
@pytest.mark.integration
def test_list_job_statuses_raises_client_error_access_denied(
    job_dynamo, mocker
):
    """
...
@pytest.mark.integration
def test_list_jobs_by_status_raises_client_error_unknown(job_dynamo, mocker):
    """
...
@pytest.mark.integration
def test_list_jobs_by_user_raises_client_error_unknown(job_dynamo, mocker):
    """
...
@pytest.mark.integration
def test_get_job_raises_client_error_resource_not_found(job_dynamo, mocker):
    """
...
@pytest.mark.integration
def test_get_job_raises_client_error_internal_server_error(job_dynamo, mocker):
    """
...
@pytest.mark.integration
def test_get_latest_job_status_raises_client_error_resource_not_found(
    job_dynamo, mocker
):
    """
