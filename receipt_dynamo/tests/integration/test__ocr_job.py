    ...
    for i in range(30):
        jobs.append(
            OCRJob(
                ...
                status=[OCRStatus.PENDING, OCRStatus.COMPLETED, OCRStatus.FAILED][i % 3],
                job_type=OCRJobType.FIRST_PASS if i % 2 == 0 else OCRJobType.REFINEMENT,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("not-a-uuid", "4f52804b-2fad-4e00-92c8-b593da3a8ed3"),  # Invalid image_id
        ("3f52804b-2fad-4e00-92c8-b593da3a8ed3", "not-a-uuid"),  # Invalid job_id
    ],
)
...
def test_ocr_job_different_job_types(
    ...
    retrieved_refinement = client.get_ocr_job(refinement_job.image_id, refinement_job.job_id)
