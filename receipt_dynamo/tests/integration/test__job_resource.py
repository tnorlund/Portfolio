...
def test_add_job_resource_success(
...
@pytest.mark.integration
def test_add_job_resource_raises_value_error(job_resource_dynamo):
...
@pytest.mark.integration
def test_add_job_resource_raises_value_error_not_instance(job_resource_dynamo):
    """
...
@pytest.mark.integration
def test_add_job_resource_raises_conditional_check_failed(
    job_resource_dynamo, sample_job, sample_job_resource
):
    """
...
@pytest.mark.integration
def test_add_job_resource_raises_resource_not_found(
...
@pytest.mark.integration
def test_get_job_resource_success(
    job_resource_dynamo, sample_job, sample_job_resource
):
...
@pytest.mark.integration
def test_get_job_resource_raises_value_error_job_id_none(job_resource_dynamo):
...
@pytest.mark.integration
def test_get_job_resource_raises_value_error_resource_id_none(
...
@pytest.mark.integration
def test_get_job_resource_raises_value_error_not_found(
    job_resource_dynamo, sample_job
):
    """
...
# ---
# update_job_resource_status
# ---


@pytest.mark.integration
def test_update_job_resource_status_success(
    job_resource_dynamo, sample_job, sample_job_resource
):
...
@pytest.mark.integration
def test_update_job_resource_status_raises_value_error_job_id_none(
    job_resource_dynamo,
):
    """
...
@pytest.mark.integration
def test_update_job_resource_status_raises_value_error_resource_id_none(
    job_resource_dynamo, sample_job
):
    """
...
@pytest.mark.integration
def test_update_job_resource_status_raises_value_error_status_none(
    job_resource_dynamo, sample_job, sample_job_resource
):
    """
...
@pytest.mark.integration
def test_update_job_resource_status_raises_value_error_invalid_status(
    job_resource_dynamo, sample_job, sample_job_resource
):
    """
...
@pytest.mark.integration
def test_update_job_resource_status_not_found(
...
@pytest.mark.integration
def test_list_job_resources_success(
...
@pytest.mark.integration
def test_list_job_resources_with_limit(
    job_resource_dynamo, sample_job, sample_job_resource, sample_job_resource_2
):
...
@pytest.mark.integration
def test_list_job_resources_with_pagination(
    job_resource_dynamo, sample_job, sample_job_resource, sample_job_resource_2
):
    ...
    # List the first page
    resources_page1, last_evaluated_key = (
        job_resource_dynamo.list_job_resources(sample_job.job_id, limit=1)
    )
...
@pytest.mark.integration
def test_list_job_resources_empty(job_resource_dynamo, sample_job):
...
@pytest.mark.integration
def test_list_resources_by_type_success(
    job_resource_dynamo, sample_job, sample_job_resource, sample_job_resource_2
):
    ...
    job_resource_dynamo.add_job_resource(
...
@pytest.mark.integration
def test_list_resources_by_type_with_limit(
    job_resource_dynamo, sample_job, sample_job_resource
):
...
@pytest.mark.integration
def test_list_resources_by_type_not_found(
    job_resource_dynamo, sample_job, sample_job_resource
):
...
@pytest.mark.integration
def test_list_resources_by_type_raises_value_error(job_resource_dynamo):
    """
...
@pytest.mark.integration
def test_get_resource_by_id_with_limit(
    job_resource_dynamo, sample_job, sample_job_resource
):
...
@pytest.mark.integration
def test_get_resource_by_id_not_found(job_resource_dynamo):
...
@pytest.mark.integration
def test_get_resource_by_id_raises_value_error(job_resource_dynamo):
...
@pytest.mark.integration
def test_list_job_resources_raises_client_error(
    job_resource_dynamo, sample_job, mocker
):
    """
...
@pytest.mark.integration
def test_list_resources_by_type_raises_client_error(
    job_resource_dynamo, mocker
):
    """
...
@pytest.mark.integration
def test_get_resource_by_id_raises_client_error(job_resource_dynamo, mocker):
    """
