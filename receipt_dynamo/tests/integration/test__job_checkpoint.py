...
def test_add_job_checkpoint_success(
...
@pytest.mark.integration
def test_add_job_checkpoint_raises_value_error(job_checkpoint_dynamo):
    """
...
@pytest.mark.integration
def test_add_job_checkpoint_raises_value_error_not_instance(
...
@pytest.mark.integration
def test_add_job_checkpoint_raises_conditional_check_failed(
    job_checkpoint_dynamo, sample_job, sample_job_checkpoint
):
    """
...
@pytest.mark.integration
def test_add_job_checkpoint_raises_resource_not_found(
...
@pytest.mark.integration
def test_get_job_checkpoint_success(
    job_checkpoint_dynamo, sample_job, sample_job_checkpoint
):
...
@pytest.mark.integration
def test_get_job_checkpoint_raises_value_error_job_id_none(
    job_checkpoint_dynamo,
):
...
@pytest.mark.integration
def test_get_job_checkpoint_raises_value_error_timestamp_none(
...
@pytest.mark.integration
def test_get_job_checkpoint_raises_value_error_not_found(
    job_checkpoint_dynamo, sample_job
):
    """
...
@pytest.mark.integration
def test_update_best_checkpoint_success(
    job_checkpoint_dynamo,
    sample_job,
...
@pytest.mark.integration
def test_update_best_checkpoint_raises_value_error_job_id_none(
    job_checkpoint_dynamo,
):
...
@pytest.mark.integration
def test_update_best_checkpoint_raises_value_error_timestamp_none(
    job_checkpoint_dynamo, sample_job
):
    """
...
@pytest.mark.integration
def test_update_best_checkpoint_raises_value_error_not_found(
    job_checkpoint_dynamo, sample_job
):
    """
...
@pytest.mark.integration
def test_list_job_checkpoints_success(
    job_checkpoint_dynamo,
    sample_job,
    sample_job_checkpoint,
    sample_job_checkpoint_2,
...
@pytest.mark.integration
def test_list_job_checkpoints_with_limit(
    job_checkpoint_dynamo,
    sample_job,
    sample_job_checkpoint,
    sample_job_checkpoint_2,
...
@pytest.mark.integration
def test_list_job_checkpoints_with_pagination(
    job_checkpoint_dynamo,
    sample_job,
    sample_job_checkpoint,
    sample_job_checkpoint_2,
...
@pytest.mark.integration
def test_list_job_checkpoints_empty(job_checkpoint_dynamo, sample_job):
...
@pytest.mark.integration
def test_get_best_checkpoint_success(
    job_checkpoint_dynamo,
    sample_job,
    sample_job_checkpoint,
    sample_job_checkpoint_2,
...
@pytest.mark.integration
def test_get_best_checkpoint_none_found(job_checkpoint_dynamo, sample_job):
...
@pytest.mark.integration
def test_get_best_checkpoint_raises_value_error_job_id_none(
    job_checkpoint_dynamo,
):
...
# ---
# delete_job_checkpoint
# ---


@pytest.mark.integration
def test_delete_job_checkpoint_success(
    job_checkpoint_dynamo, sample_job, sample_job_checkpoint
):
...
@pytest.mark.integration
def test_delete_job_checkpoint_raises_value_error_job_id_none(
    job_checkpoint_dynamo,
):
...
@pytest.mark.integration
def test_delete_job_checkpoint_raises_value_error_timestamp_none(
    job_checkpoint_dynamo, sample_job
):
    """
...
# ---
# list_all_job_checkpoints
# ---


@pytest.mark.integration
def test_list_all_job_checkpoints_success(
    job_checkpoint_dynamo,
    sample_job,
    sample_job_checkpoint,
    sample_job_checkpoint_2,
...
@pytest.mark.integration
def test_list_all_job_checkpoints_with_limit(
    job_checkpoint_dynamo,
    sample_job,
    sample_job_checkpoint,
    sample_job_checkpoint_2,
...
@pytest.mark.integration
def test_list_job_checkpoints_raises_client_error(
...
@pytest.mark.integration
def test_list_all_job_checkpoints_raises_client_error(
