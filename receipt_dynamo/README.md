...
| **Receipt Field Group**         | `FIELD_GROUP#<group_type>` | `IMAGE#<image_id>#RECEIPT#<receipt_id>`                                 | `IMAGE#<image_id>`      | `RECEIPT#<receipt_id>#FIELD_GROUP#<group_type>`                                 | `RECEIPT`              | `IMAGE#<image_id>#RECEIPT#<receipt_id>`                                         |                    |                                                       | - `words: [{word_id, line_id, label}]` <br>- `confidence` <br>- `timestamp_added`                                      |
