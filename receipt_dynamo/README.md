...
| **Receipt Label Analysis**      | `IMAGE#<image_id>`         | `RECEIPT#<receipt_id>#ANALYSIS#LABELS`                                  | `ANALYSIS_TYPE`         | `LABELS#<timestamp>`                                                            | `RECEIPT`              | `IMAGE#<image_id>#RECEIPT#<receipt_id>`                                         |                    |                                                       | - `labels: [{label_type, line_id, word_id, text, reasoning, position}]` <br>- `timestamp_added` <br>- `version` <br>- `overall_reasoning` |
| **Receipt Structure Analysis**  | `IMAGE#<image_id>`         | `RECEIPT#<receipt_id>#ANALYSIS#STRUCTURE`                               | `ANALYSIS_TYPE`         | `STRUCTURE#<timestamp>`                                                         | `RECEIPT`              | `IMAGE#<image_id>#RECEIPT#<receipt_id>`                                         |                    |                                                       | - `sections: [{name, line_ids, reasoning, spatial_patterns, content_patterns}]` <br>- `overall_reasoning` <br>- `timestamp_added` <br>- `version` |
| **Receipt Line Item Analysis**  | `IMAGE#<image_id>`         | `RECEIPT#<receipt_id>#ANALYSIS#LINE_ITEMS`                              | `ANALYSIS_TYPE`         | `LINE_ITEMS#<timestamp>`                                                        | `RECEIPT`              | `IMAGE#<image_id>#RECEIPT#<receipt_id>`                                         |                    |                                                       | - `items: [{description, quantity: {amount, unit}, price: {unit_price, extended_price}, line_ids, reasoning}]` <br>- `subtotal` <br>- `tax` <br>- `total` <br>- `total_found: bool` <br>- `discrepancies: []` <br>- `reasoning` <br>- `timestamp_added` <br>- `version` |
| **Receipt Validation Analysis** | `IMAGE#<image_id>`         | `RECEIPT#<receipt_id>#ANALYSIS#VALIDATION`                              | `ANALYSIS_TYPE`         | `VALIDATION#<timestamp>`                                                        | `RECEIPT`              | `IMAGE#<image_id>#RECEIPT#<receipt_id>`                                         | `VALIDATION_STATUS#<status>` | `TIMESTAMP#<timestamp>`                     | - `business_identity: [{type: "error\|warning\|info", message: str, reasoning: str}]` <br>- `address_verification: [{type, message, reasoning}]` <br>- `phone_validation: [{type, message, reasoning}]` <br>- `hours_verification: [{type, message, reasoning}]` <br>- `cross_field_consistency: [{type, message, reasoning}]` <br>- `line_item_validation: [{type, message, reasoning}]` <br>- `overall_valid: bool` <br>- `validation_status: "VALID\|INVALID_BUSINESS\|INVALID_ADDRESS\|INVALID_PHONE\|INVALID_HOURS\|INVALID_TOTALS\|INVALID_LINE_ITEMS"` <br>- `prompt_template: str` <br>- `response_template: str` <br>- `timestamp_added: str` <br>- `version: str` |
