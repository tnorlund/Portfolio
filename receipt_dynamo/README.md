...
| **Batch Summary**               | `BATCH#<batch_id>`       | `STATUS`                                                                               | `STATUS#<status>`             | `BATCH#<batch_id>`                                                    |                                     |                                                                       |                                         |                                                                    | - `batch_type` <br> - `openai_batch_id` <br> - `submitted_at` <br> - `status` <br> - `word_count` <br> - `result_file_id` <br> - `receipt_refs`                                                                                                                                                                                                                                                                                                                                                       |
