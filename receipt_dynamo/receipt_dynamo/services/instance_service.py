...
class InstanceService:
    ...
    def list_instances_by_status(
        ...
        Returns:
            A tuple containing a list of Instance objects and the last evaluated key
        """
        return self.dynamo_client.listInstancesByStatus(status, limit, last_evaluated_key)
    ...
    def list_instances_by_type(
        ...
        Returns:
            A tuple containing a list of Instance objects and the last evaluated key
        """
        return self.dynamo_client.listInstancesByType(instance_type, limit, last_evaluated_key)
    ...
    def assign_job_to_instance(
        self, instance_id: str, job_id: str, metadata: Optional[Dict[str, Any]] = None
    ) -> InstanceJob:
        """
    ...
    def update_instance_job_status(
        self, instance_id: str, job_id: str, status: str, message: Optional[str] = None
    ) -> InstanceJob:
        """
