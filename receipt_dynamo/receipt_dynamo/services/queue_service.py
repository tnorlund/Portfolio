...
class QueueService:
    ...
    def add_job_to_queue(
        self, queue_id: str, job_id: str, priority: int = 0, metadata: Optional[Dict[str, Any]] = None
    ) -> QueueJob:
        """
    ...
    def list_jobs_in_queue(
        self, queue_id: str, limit: Optional[int] = None, last_evaluated_key: Optional[Dict] = None
        ...
        """
        return self.dynamo_client.listQueueJobsByQueue(queue_id, limit, last_evaluated_key)
    
    def list_queues_for_job(
        self, job_id: str, limit: Optional[int] = None, last_evaluated_key: Optional[Dict] = None
    ) -> tuple[list[QueueJob], Optional[Dict]]:
        """
