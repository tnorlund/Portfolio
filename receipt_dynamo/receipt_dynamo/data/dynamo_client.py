...
from receipt_dynamo.data._receipt_line_item_analysis import _ReceiptLineItemAnalysis
...
from receipt_dynamo.data._receipt_structure_analysis import _ReceiptStructureAnalysis
