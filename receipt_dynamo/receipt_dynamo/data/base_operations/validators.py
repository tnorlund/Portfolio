...
class ValidationMessageGenerator:
    ...
    def generate_message(self, message_type: str, param_name: str, class_name: Optional[str] = None) -> str:
        """
    ...
    def _generate_required_message(self, param_name: str, class_name: Optional[str] = None) -> str:
    ...
    def _generate_list_type_mismatch_message(self, param_name: str, class_name: str) -> str:
...
class EntityValidator:
    ...
    def __init__(self, config: ErrorMessageConfig) -> None:
        ...
        self._validation_rules: Dict[str, List[Tuple[str, Callable[[Dict[str, Any]], None]]]] = {
            "single_entity": [
    ...
    def _run_validation_chain(self, validation_type: str, context: Dict[str, Any]) -> None:
        """
    ...
    def transform_validation_message(self, message: str, operation: str) -> str:
        ...
        transformation_rules: Dict[str, Dict[str, Union[List[str], Dict[str, str]]]] = {
            ...
            "remove_given": {
                "pattern_match": ["receipt_label_analysis"],
                "transformations": {
        ...
        for rule_name, rule_config in transformation_rules.items():
            ...
            if isinstance(pattern_match, list) and any(pattern in operation for pattern in pattern_match):
                # Apply all transformations for this rule
                if isinstance(transformations, dict):
                    for old_text, new_text in transformations.items():
                        transformed_message = transformed_message.replace(old_text, new_text)
