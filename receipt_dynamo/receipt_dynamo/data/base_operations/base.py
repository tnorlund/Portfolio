...
class DynamoDBBaseOperations(DynamoClientProtocol):
    ...
    def _validate_entity(self, entity: Any, entity_class: Type, param_name: str) -> None:
        """
    ...
    def _validate_entity_list(self, entities: List[Any], entity_class: Type, param_name: str) -> None:
        """
    ...
    def _batch_write_with_retry(
        ...
        for attempt in range(max_retries + 1):
            response = self._client.batch_write_item(RequestItems=formatted_items)
            ...
            if attempt < max_retries:
                ...
                raise RuntimeError(f"Failed to process all items after {max_retries} retries")