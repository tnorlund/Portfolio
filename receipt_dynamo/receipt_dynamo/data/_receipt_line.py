...
class _ReceiptLine:
    ...
    def getReceiptLine(self, receipt_id: int, image_id: str, line_id: int) -> ReceiptLine:
    ...
    def listReceiptLines(self, limit: int = None, lastEvaluatedKey: dict | None = None) -> list[ReceiptLine]:
        """Returns all ReceiptLines from the table."""
        ...
        try:
            ...
            if error_code == "ResourceNotFoundException":
                raise Exception(f"Could not list receipt lines from DynamoDB: {e}") from e
    ...
    def listReceiptLinesFromReceipt(self, receipt_id: int, image_id: str) -> list[ReceiptLine]:
        """Returns all lines under a specific receipt/image."""
        receipt_lines = []
        try:
