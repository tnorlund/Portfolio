...
class _ReceiptWordTag(DynamoClientProtocol):
    ...
    def add_receipt_word_tag(self, receipt_word_tag: ReceiptWordTag):
        """
    ...
    def delete_receipt_word_tags_from_image(self, image_id: str):
        ...
        Args:
            image_id (int): The image ID.
        """
        tags = self.list_receipt_word_tags_from_image(image_id)
        self.delete_receipt_word_tags(tags)
    ...
    def get_receipt_word_tag(
        ...
        try:
            ...
            return item_to_receipt_word_tag(response["Item"])
        except KeyError:
    ...
    def get_receipt_word_tags(
        ...
        receipt_tags = []
        try:
            # If a limit is provided, use it as the batch size; otherwise
            # choose a default batch size.
    ...
    def list_receipt_word_tags_from_image(self, image_id: str) -> list[ReceiptWordTag]:
        """
