...
class _EmbeddingBatchResult(DynamoClientProtocol):
    ...
    def addEmbeddingBatchResult(self, embedding_batch_result: EmbeddingBatchResult):
        """
    ...
    def updateEmbeddingBatchResult(self, embedding_batch_result: EmbeddingBatchResult):
        """
        ...
        try:
            ...
            if error_code == "ConditionalCheckFailedException":
                ...
                raise Exception(f"Error updating embedding batch result: {e}") from e
    ...
    def updateEmbeddingBatchResults(
        ...
        for i in range(0, len(embedding_batch_results), 25):
            ...
            try:
                ...
                raise Exception(f"Error updating embedding batch results: {e}") from e

    def deleteEmbeddingBatchResult(self, embedding_batch_result: EmbeddingBatchResult):
        """
        ...
        try:
            ...
            if error_code == "ConditionalCheckFailedException":
                ...
                raise Exception(f"Error deleting embedding batch result: {e}") from e
    ...
    def deleteEmbeddingBatchResults(
        ...
        for i in range(0, len(embedding_batch_results), 25):
            ...
            try:
                ...
                raise Exception(f"Error deleting embedding batch results: {e}") from e
    ...
    def listEmbeddingBatchResults(
        ...
        try:
            ...
            while True:
                ...
                results.extend(
                    [itemToEmbeddingBatchResult(item) for item in response["Items"]]
                )
