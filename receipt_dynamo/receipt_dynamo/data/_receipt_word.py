...
class _ReceiptWord:
    ...
    def deleteReceiptWord(self, receipt_id: int, image_id: str, line_id: int, word_id: int):
        """Deletes a single ReceiptWord by IDs."""
        try:
    ...
    def getReceiptWord(self, receipt_id: int, image_id: str, line_id: int, word_id: int) -> ReceiptWord:
        """Retrieves a single ReceiptWord by IDs."""
        try:
    ...
    def listReceiptWords(self, limit: int = None, lastEvaluatedKey: dict | None = None) -> list[ReceiptWord]:
        """Returns all ReceiptWords from the table."""
    ...
    def listReceiptWordsFromLine(self, receipt_id: int, image_id: str, line_id: int) -> list[ReceiptWord]:
        """Returns all ReceiptWords that match the given receipt/image/line IDs."""
        receipt_words = []
        try:
