...
def upload_box_file_to_dynamodb(
    box_file_path, dynamodb_table_name, aws_region="us-east-1"
):
...
upload_box_file_to_dynamodb(
    "out/Rec86.box", stack_outputs["table_name"].value, stack_outputs["region"].value
)
