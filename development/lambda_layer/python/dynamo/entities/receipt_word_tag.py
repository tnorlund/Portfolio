...
class ReceiptWordTag:
    ...
    def __repr__(self) -> str:
        return f"ReceiptWordTag(word_id={self.word_id}, tag={self.tag})"
    ...
    def key(self) -> dict:
        ...
        return {
            ...
            "SK": {
                "S": f"TAG#{spaced_tag_upper}#RECEIPT#{self.receipt_id:05d}#WORD#{self.word_id:05d}"
            },
        }
    ...
    def gsi1_key(self) -> dict:
        ...
        return {
            ...
            "GSI1SK": {"S": f"RECEIPT#{self.receipt_id:05d}#WORD#{self.word_id:05d}"},
        }
