...
from .models import MetadataUpdateResult  # Reuse this for receipt deletion results
    ...
    try:
        ...
        try:
            ...
            if results and any(r.updated_count > 0 for r in results if r.error is None):
                logger.info("Uploading updated snapshot after receipt deletion", collection=database)
