...
def setup_test_environment():
    ...
    compaction_mock.process_place_updates = MagicMock()
    compaction_mock.process_label_updates = MagicMock()
    compaction_mock.process_compaction_run_messages = MagicMock()
    compaction_mock.update_receipt_place = MagicMock()
    compaction_mock.remove_receipt_place = MagicMock()
    ...
    compaction_operations_mock.update_receipt_place = MagicMock()
    compaction_operations_mock.remove_receipt_place = MagicMock()
