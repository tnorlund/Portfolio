...
class StreamProcessorLambda(ComponentResource):
    ...
    def __init__(
        ...
        self.sqs_policy = aws.iam.RolePolicy(
            ...
            role=self.lambda_role.id,
            policy=Output.all(
                chromadb_queues.delta_queue_arn,
                chromadb_queues.dlq_arn
            ).apply(
                lambda args: json.dumps({
                    "Version": "2012-10-17",
                    "Statement": [
        ...
        self.function = aws.lambda_.Function(
            ...
            code=pulumi.AssetArchive({
                "stream_processor.py": pulumi.FileAsset("chromadb_compaction/stream_processor.py"),
            }),
...
class DynamoDBStreamEventSourceMapping(ComponentResource):
    ...
    def __init__(
        ...
        Args:
            ...
            opts: Optional resource options
        """
        super().__init__("chromadb:stream:EventSourceMapping", name, None, opts)
