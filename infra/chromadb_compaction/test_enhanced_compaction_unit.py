...
class TestEnhancedCompactionLogic:
    ...
    def test_process_metadata_update_logic(self, mock_lock_manager_class, mock_dynamo_client_class, 
                                         mock_chromadb, mock_boto3):
    ...
    @patch('enhanced_compaction_handler.DynamoClient')
    @patch('enhanced_compaction_handler.LockManager')
    def test_remove_metadata_logic(self, mock_lock_manager_class, mock_dynamo_client_class, 
                                 mock_chromadb, mock_boto3):
    ...
    @patch('enhanced_compaction_handler.DynamoClient')
    @patch('enhanced_compaction_handler.LockManager')
    def test_update_word_labels_logic(self, mock_lock_manager_class, mock_dynamo_client_class, 
                                    mock_chromadb, mock_boto3):
        ...
        # Test the update logic
        updated_count = update_word_labels(mock_collection, chromadb_id, changes)
        ...
        assert metadata["existing_field"] == "value"  # Original fields preserved
    ...
    @patch('enhanced_compaction_handler.DynamoClient')
    @patch('enhanced_compaction_handler.LockManager')
    def test_remove_word_labels_logic(self, mock_lock_manager_class, mock_dynamo_client_class, 
                                    mock_chromadb, mock_boto3):
