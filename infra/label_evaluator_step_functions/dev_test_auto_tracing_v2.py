...
print("\nKey comparisons:")
print("  Test 2 vs 3: Does wrapping root in tracing_context help?")
print("  Test 2 vs 4: Does explicit session_name help?")
print("  Test 5 vs 6: Full production sim — with vs without root wrap")
