...
each receipt evaluation. The evaluation logic, LLM calls, and
issues found will all be visible in the unified LangSmith trace.
"""
...
def handler(event: dict[str, Any], _context: Any) -> "EvaluateLabelsOutput":
    ...
    try:
        ...
        with resume_trace(
            "evaluate_labels",
            event,
            metadata={"data_s3_key": data_s3_key},
            ...
            output = trace_ctx.wrap_output(output)
