...
async def unified_receipt_evaluator(
    ...
    with receipt_state_trace(
        ...
        try:
            ...
            # 1. Load receipt data from S3 (once)
            ...
            # 3. Build visual lines (shared across all evaluations)
            ...
            # 4. Create shared LLM invoker (used by all evaluations)
            ...
            # 5. Phase 1: Run currency, metadata, and geometric evaluations concurrently
            ...
            # 6. Apply Phase 1 corrections to DynamoDB
            ...
            # 7. Phase 2: Financial validation (needs corrected labels from Phase 1)
            ...
            # 8. Phase 3: LLM review of flagged geometric issues (if any)
