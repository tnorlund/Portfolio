"""Lambda handler for serving word similarity cache."""
...
def handler(event, _context):
    """Handle API Gateway requests for word similarity cache.
    ...
    Returns:
        dict: HTTP response with cached word similarity data or error
    """
