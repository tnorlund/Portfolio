...
def test_image_add(dynamodb_table, example_image):
    """
    This test focuses on adding an image, but also verifies that we can
    retrieve it via getImage to demonstrate integration between the two methods.
    """
...
def test_listImageDetails_pagination_no_limit_returns_all(dynamodb_table):
    ...
    image_3 = Image(
        "3f52804b-2fad-4e00-92c8-b593da3a8ed5",
        50,
        60,
        "2021-01-01T00:00:00",
        "bucket",
...
def test_listImageDetails_pagination_with_limit_exceeds_count(dynamodb_table):
    ...
    image_2 = Image(
        "3f52804b-2fad-4e00-92c8-b593da3a8ed2",
        30,
        40,
        "2021-01-01T00:00:00",
        "bucket",
