...
def test_receipt_word_tag_init_empty_tag():
    ...
    with pytest.raises(ValueError, match="tag must not be empty"):
        ReceiptWordTag("3f52804b-2fad-4e00-92c8-b593da3a8ed3", 2, 3, 4, "", "2021-01-01T00:00:00")
...
def test_receipt_word_tag_init_long_tag():
    ...
    with pytest.raises(ValueError, match="tag must not exceed 40 characters"):
        ReceiptWordTag("3f52804b-2fad-4e00-92c8-b593da3a8ed3", 2, 3, 4, long_tag, timestamp_added="2021-01-01T00:00:00")
...
def test_receipt_word_tag_init_underscore_tag():
    ...
    with pytest.raises(ValueError, match="tag must not start with an underscore"):
        ReceiptWordTag("3f52804b-2fad-4e00-92c8-b593da3a8ed3", 2, 3, 4, "_bad", timestamp_added="2021-01-01T00:00:00")
...
def test_receipt_word_tag_key(example_receipt_word_tag):
    ...
    assert item_key["SK"]["S"] == "RECEIPT#00045#LINE#00006#WORD#00789#TAG#____________________________________food"
...
def test_receipt_word_tag_gsi1_key(example_receipt_word_tag):
    ...
    assert gsi_key["GSI1SK"]["S"] == "IMAGE#3f52804b-2fad-4e00-92c8-b593da3a8ed3#RECEIPT#00045#LINE#00006#WORD#00789"
...
def test_item_to_receipt_word_tag():
    ...
    raw_item = {
        ...
        "SK": {"S": "RECEIPT#00005#LINE#00002#WORD#00099#TAG#____________________________________food"},
        "GSI1PK": {"S": "TAG#____________________________________food"},
        "GSI1SK": {"S": "IMAGE#3f52804b-2fad-4e00-92c8-b593da3a8ed3#RECEIPT#00005#LINE#00002#WORD#00099"},
...
def test_item_to_receipt_word_tag_bad_format():
    ...
    bad_item = {
        ...
        "GSI1PK": {"S": "TAG#FOOD"},
        "GSI1SK": {"S": "IMAGE#3f52804b-2fad-4e00-92c8-b593da3a8ed3#RECEIPT#00005#LINE#00006#WORD#999"},
        "TYPE": {"S": "RECEIPT_WORD_TAG"},
    }
