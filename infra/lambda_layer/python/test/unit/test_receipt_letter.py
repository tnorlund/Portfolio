...
def test_to_item(example_receipt_letter):
    ...
    assert example_receipt_letter.to_item() == {
        ...
        "bounding_box": {
            "M": {
                "height": {"N": "0.050000000000000000"},
                "width": {"N": "0.050000000000000000"},
        ...
        "top_right": {
            "M": {
                "x": {"N": "0.150000000000000000"},
                "y": {"N": "0.250000000000000000"},
            }
        },
        "top_left": {
            "M": {
        ...
        "angle_degrees": {"N": "5.0000000000"},
        "angle_radians": {"N": "0.0872665000"},
        "confidence": {"N": "0.98"},
    }
