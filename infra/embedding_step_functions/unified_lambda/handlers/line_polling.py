"""Line polling handler for OpenAI batch results - unified container version."""
...
class LinePollingHandler(BaseLambdaHandler):
    ...
    def _handle_completed_batch(
        ...
        self.logger.info("Downloaded %d line embedding results", len(results))
        ...
        self.logger.info("Updated line embedding status to SUCCESS")

        # Mark batch complete
        mark_batch_complete(batch_id)
        self.logger.info("Marked batch %s as complete", batch_id)
    ...
    def handle(self, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
        ...
        self.logger.info("Batch %s status: %s", openai_batch_id, batch_status)
        ...
        if (
            ...
            if partial_results:
                ...
                self.logger.info("Processed partial line embedding results")
