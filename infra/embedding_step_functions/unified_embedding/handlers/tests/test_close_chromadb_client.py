...
# Mock receipt_dynamo and receipt_label (they're not needed for testing close_chromadb_client)
...
sys.modules['receipt_label'] = MagicMock()
sys.modules['receipt_label.utils'] = MagicMock()
sys.modules['receipt_label.utils.lock_manager'] = MagicMock()
sys.modules['receipt_label.utils.chroma_s3_helpers'] = MagicMock()
sys.modules['receipt_label.vector_store'] = MagicMock()
