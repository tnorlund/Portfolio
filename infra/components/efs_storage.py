...
class EFSStorage(ComponentResource):
    ...
    def __init__(
        ...
        Args:
            ...
            subnet_ids: Input containing list of subnet IDs for mount targets
        ...
        component_opts = (
            ...
            if opts is not None
            else ResourceOptions(parent=self)
        )
            ...
            lifecycle_policies=(
                [
                    aws.efs.FileSystemLifecyclePolicyArgs(
                        transition_to_ia=lifecycle_policy.get(
            ...
            for i, subnet_id in enumerate(resolved_subnet_ids):
                mt = aws.efs.MountTarget(
                    ...
                    opts=ResourceOptions.merge(
                        component_opts,
                        ResourceOptions(parent=self.file_system),
        ...
        self.mount_targets_output = pulumi.Output.from_input(subnet_ids).apply(
