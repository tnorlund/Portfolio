...
def test_init():
    ...
    # x
    with pytest.raises(ValueError):
        Line(1, 1, "06\/27\/2024", -0.1, 0.8868912353567051, 0.0872786737257435, 0.024234482472679675, 7.7517295, 1)
        Line(1, 1, "06\/27\/2024", 1, 0.8868912353567051, 0.0872786737257435, 0.024234482472679675, 7.7517295, 1)
    # y
    with pytest.raises(ValueError):
        Line(1, 1, "06\/27\/2024", 0.14956954529503239, -0.1, 0.0872786737257435, 0.024234482472679675, 7.7517295, 1)
    ...
    # angle
    with pytest.raises(ValueError):
        Line(1, 1, "06\/27\/2024", 0.14956954529503239, 0.8868912353567051, 0.0872786737257435, 0.024234482472679675, -0.1, 1)
        Line(1, 1, "06\/27\/2024", 0.14956954529503239, 0.8868912353567051, 0.0872786737257435, 0.024234482472679675, 1, 1)
    # confidence
    with pytest.raises(ValueError):
