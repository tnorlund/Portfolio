...
[portfolio](../../modules.md) / types/api
...
- [ImagesApiResponse](interfaces/ImagesApiResponse.md)
- [LabelEvaluatorAggregateStats](interfaces/LabelEvaluatorAggregateStats.md)
- [LabelEvaluatorDecision](interfaces/LabelEvaluatorDecision.md)
- [LabelEvaluatorEvaluation](interfaces/LabelEvaluatorEvaluation.md)
- [LabelEvaluatorGeometric](interfaces/LabelEvaluatorGeometric.md)
- [LabelEvaluatorIssue](interfaces/LabelEvaluatorIssue.md)
- [LabelEvaluatorReceipt](interfaces/LabelEvaluatorReceipt.md)
- [LabelEvaluatorResponse](interfaces/LabelEvaluatorResponse.md)
- [LabelEvaluatorWord](interfaces/LabelEvaluatorWord.md)
- [LabelValidationAggregateStats](interfaces/LabelValidationAggregateStats.md)
- [LabelValidationCountResponse](interfaces/LabelValidationCountResponse.md)
- [LabelValidationKeyframe](interfaces/LabelValidationKeyframe.md)
- [LabelValidationReceipt](interfaces/LabelValidationReceipt.md)
- [LabelValidationResponse](interfaces/LabelValidationResponse.md)
- [LabelValidationStatusCounts](interfaces/LabelValidationStatusCounts.md)
- [LabelValidationTier](interfaces/LabelValidationTier.md)
- [LabelValidationTimelineResponse](interfaces/LabelValidationTimelineResponse.md)
- [LabelValidationWord](interfaces/LabelValidationWord.md)
- [LayoutLMAggregateStats](interfaces/LayoutLMAggregateStats.md)
- [LayoutLMBatchInferenceResponse](interfaces/LayoutLMBatchInferenceResponse.md)
- [LayoutLMEntitiesSummary](interfaces/LayoutLMEntitiesSummary.md)
- [LayoutLMPrediction](interfaces/LayoutLMPrediction.md)
