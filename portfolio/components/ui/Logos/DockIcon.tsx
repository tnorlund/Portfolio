...
/**
 * An app icon bouncing the way a Dock icon does when you click it and the
 * app is still launching. Bounces three times on entering the viewport,
 * then rests. Honors prefers-reduced-motion.
 */
const SIZE = 128;
