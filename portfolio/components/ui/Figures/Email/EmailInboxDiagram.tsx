  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Inbox */}
        <EnvelopeIcon x={50} y={ROW_Y} scale={1.1} />
        <text x={50} y={LABEL_Y} {...LABEL_TEXT_PROPS}>
          Inbox
        </text>

        {/* SES */}
        <g transform={`translate(${220 - 42.5},${ROW_Y - 42.5})`}>
          <rect width="85" height="85" rx="6" fill="url(#email-ses-gradient)" />
        </g>
        <EnvelopeIcon x={220} y={ROW_Y} fill="white" stroke="#b0084d" scale={0.8} />
        <text x={220} y={LABEL_Y} {...LABEL_TEXT_PROPS}>
          SES
        </text>

        {/* S3 */}
        <S3Icon x={390} y={ROW_Y} gradientId="email-s3-gradient" />
        <text x={390} y={LABEL_Y} {...LABEL_TEXT_PROPS}>
          S3 raw/
        </text>

        {/* Hidden rails */}
        <FanPaths refs={PATH_REFS.InboxToSes} x1={84} y1={ROW_Y} x2={175} y2={ROW_Y} />
        <FanPaths refs={PATH_REFS.SesToS3} x1={265} y1={ROW_Y} x2={345} y2={ROW_Y} />
