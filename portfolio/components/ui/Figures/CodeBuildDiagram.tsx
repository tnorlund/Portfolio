            ...
            <svg height="400" width="300" viewBox="0 0 300 400">
              ...
              <g id="Codebuild_lambda">
                <path
                  ...
                  fill="none"
                  stroke="none"
                  ref={PATH_REFS.PipelineToLambda[0]}
                />
                <path
                  d="M150.24,361.25c0-13.13,1.64-36.16,1.64-49.29,0-22.71-1.64-35.51-1.64-58.21"
                  fill="none"
                  stroke="none"
                  ref={PATH_REFS.PipelineToLambda[1]}
                />
                <path
                  d="M150.24,361.25c0-13.13-1.64-36.16-1.64-49.29,0-22.71,1.64-35.51,1.64-58.21"
                  fill="none"
                  stroke="none"
                  ref={PATH_REFS.PipelineToLambda[2]}
                />
                <path
                  d="M150.24,361.25c0-13.13,3.27-36.16,3.27-49.29,0-22.71-3.27-35.51-3.27-58.21"
                  fill="none"
                  stroke="none"
                  ref={PATH_REFS.PipelineToLambda[3]}
                />
                <path
                  d="M150.24,361.25c0-13.13-3.27-36.16-3.27-49.29,0-22.71,3.27-35.51,3.27-58.21"
                  fill="none"
                  stroke="none"
                  ref={PATH_REFS.PipelineToLambda[4]}
                />
              </g>
