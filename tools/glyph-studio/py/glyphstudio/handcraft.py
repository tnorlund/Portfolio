    ...
    return {
        ...
        "B": [
            ...
            },
            {
                ...
                "nodes": [
                    node(L, 520),
                    node(Rt, 380, h_in=(Rt, 520), smooth=True),
                    node(Rt, 130, h_out=(Rt, BASE), smooth=True),
                    node(L, BASE),
                ],
            },
        ],
        ...
        "s": [
            {
                "closed": False,
                "nodes": [
                    node(Rt - 30, XH - 60, h_in=(Rt - 40, XH)),
                    node(
                        M,
                        XH,
                        h_in=(M + 110, XH),
                    ...
                    node(L + 30, BASE + 70, h_out=(L + 40, BASE)),
                ],
            },
        ],
