...
class TestParseValidationResponse:
    ...
    def test_parse_valid_response(self):
        ...
        response_text = """
        [
            {"index": 0, "decision": "VALID", "label": "GRAND_TOTAL", "confidence": "high", "reasoning": "Correct"},
    ...
    def test_parse_duplicate_index_keeps_first(self):
        ...
        response_text = """
        [
            {"index": 0, "decision": "VALID", "label": "GRAND_TOTAL", "confidence": "high", "reasoning": "First"},
    ...
    def test_parse_invalid_index_dropped(self):
        ...
        response_text = """
        [
            {"index": "abc", "decision": "VALID", "label": "GRAND_TOTAL", "confidence": "high", "reasoning": "Bad"},
            {"index": null, "decision": "VALID", "label": "GRAND_TOTAL", "confidence": "high", "reasoning": "Null"}
        ]
        """
    ...
    def test_parse_unknown_decision_becomes_needs_review(self):
        ...
        response_text = """
        [
            {"index": 0, "decision": "UNKNOWN_DECISION", "label": "GRAND_TOTAL", "confidence": "high", "reasoning": "?"}
        ]
        """
        ...
        response = LabelValidationResponse(
            decisions=[
                LabelDecision(
                    index=0,
                    decision="INVALID",
                    label="GRAND_TOTAL",  # Same as original - no correction
                    confidence="high",
