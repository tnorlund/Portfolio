...
class TestBoundaryFitting:
    ...
    def test_hardcoded_boundary_values(self) -> None:
        ...
        boundaries = {
            ...
            "left": {"isVertical": True, "x": 0.234, "slope": 0.0, "intercept": 0.0},
            "right": {"isVertical": True, "x": 0.726, "slope": 0.0, "intercept": 0.0}
        }
...
def create_boundary_line_from_theil_sen_fixed(theil_result: Dict[str, float]) -> Dict[str, float]:
