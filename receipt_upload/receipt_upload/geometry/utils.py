...
def compute_rotated_bounding_box_corners(
    ...
    top_right = line_intersection(
        top_left_pt, top_dir, right_extreme, side_dir
    )
    bottom_left = line_intersection(
        bottom_left_pt, bottom_dir, left_extreme, side_dir
    )
    bottom_right = line_intersection(
        bottom_left_pt, bottom_dir, right_extreme, side_dir
    )
    ...
    if any(
        ...
        bottom_right = (
            max_hull_x,
            max_hull_y,
        )  # bottom-right (high Y in image coords)
